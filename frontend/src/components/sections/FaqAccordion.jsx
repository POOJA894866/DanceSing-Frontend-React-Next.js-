      ...
      <div style={{ width: '100%', maxWidth: '1200px', margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '80px', alignItems: 'start' }}>
        ...
        <div>
          ...
          <div style={{ background: '#f8fafc', padding: '32px', borderRadius: '16px', border: '1px solid #e2e8f0' }}>
            <p style={{ fontSize: '15px', color: '#475569', marginBottom: '12px', lineHeight: '1.5' }}>
            ...
            return (
              <div key={idx} style={{ background: '#f8fafc', borderRadius: '12px', border: '1px solid #e2e8f0', overflow: 'hidden' }}>
                ...
                >
                  ...
                  <div style={{ width: '24px', height: '24px', borderRadius: '50%', background: '#cbd5e1', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#1e2445', fontSize: '16px', fontWeight: 'bold', flexShrink: 0 }}>
                    {isOpen ? '−' : '+'}
                  </div>
                </button>
