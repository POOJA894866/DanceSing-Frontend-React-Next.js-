    ...
    <section className="cta-banner" id={data.id || 'cta-banner'} style={{ background: '#283466', padding: '100px 0', color: 'white' }}>
      <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr 1.1fr', gap: '80px', alignItems: 'center' }}>
        ...
        <div>
          ...
          <h2 style={{ fontSize: '52px', fontWeight: '800', fontFamily: 'var(--font-serif)', marginBottom: '24px', lineHeight: '1.1', letterSpacing: '-0.02em' }}>
            Listen now <br/> on air
          </h2>
          ...
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            <a href="#" style={{ background: '#D48441', color: 'white', padding: '14px 32px', borderRadius: '12px', fontWeight: '700', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '10px', fontSize: '16px', boxShadow: '0 10px 20px rgba(212,132,65,0.2)' }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg>
              Listen Live
            </a>
            <a href="#" style={{ border: '2px solid rgba(255,255,255,0.3)', color: 'white', padding: '14px 32px', borderRadius: '12px', fontWeight: '700', textDecoration: 'none', fontSize: '16px' }}>
              Learn more
            </a>
          </div>
        </div>
