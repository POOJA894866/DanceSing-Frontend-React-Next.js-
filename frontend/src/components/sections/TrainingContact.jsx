...
const TrainingContact = ({ data }) => {
  ...
  return (
    <section style={{ background: 'white', padding: '96px 5%' }}>
      <style>{`
        .training-contact-input::placeholder {
          color: rgba(255, 255, 255, 0.7);
        }
        .training-contact-input:focus {
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '48px' }}>
            <div style={{ display: 'flex', gap: '12px', alignItems: 'center', fontSize: '15px' }}>
              <strong style={{ color: 'white', minWidth: '130px', fontFamily: 'Roboto, sans-serif' }}>{email_label}</strong>
            ...
            <div style={{ display: 'flex', gap: '12px', alignItems: 'center', fontSize: '15px' }}>
              <strong style={{ color: 'white', minWidth: '130px', fontFamily: 'Roboto, sans-serif' }}>{response_label}</strong>
              <span style={{ color: 'rgba(255, 255, 255, 0.85)', fontFamily: 'Roboto, sans-serif' }}>{response_text}</span>
            </div>

            <div style={{ display: 'flex', gap: '12px', alignItems: 'center', fontSize: '15px' }}>
              <strong style={{ color: 'white', minWidth: '130px', fontFamily: 'Roboto, sans-serif' }}>{rating_label}</strong>
              <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                <div style={{ display: 'flex', gap: '2px', marginRight: '8px' }}>
                  <StarIcon /><StarIcon /><StarIcon /><StarIcon /><StarIcon />
                </div>
                <span style={{ color: 'rgba(255, 255, 255, 0.85)', fontFamily: 'Roboto, sans-serif' }}>{rating_text}</span>
              </div>
            </div>
          </div>
        ...
        <div style={{ padding: '64px' }}>
          ...
          <form style={{ display: 'flex', flexDirection: 'column', gap: '16px' }} onSubmit={(e) => e.preventDefault()}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <input
                className="training-contact-input"
                type="text"
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'rgba(255, 255, 255, 0.8)', fontSize: '13px', fontFamily: 'Roboto, sans-serif' }}>
              <ClockIcon />
