  ...
  return (
    <section className={`section steps bg-${data.background || 'white'}`} id={data.id || 'steps'} style={{ padding: '100px 0', background: '#f8fafc' }}>
      <div style={{ width: '100%', maxWidth: '1200px', margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '44px', fontWeight: '800', color: '#1e2445', marginBottom: '24px', lineHeight: '1.2', letterSpacing: '-0.02em' }}>
          Why danceSing Works
        </h2>

        <p style={{ fontSize: '17px', color: '#64748b', lineHeight: '1.7', maxWidth: '820px', margin: '0 auto 64px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '32px', alignItems: 'stretch' }}>
          ...
          {/* Card 1: The Problem */}
          <div style={{ background: 'white', borderRadius: '20px', borderTop: '8px solid #1e2445', padding: '40px 32px', boxShadow: '0 10px 30px rgba(0,0,0,0.03)', position: 'relative', textAlign: 'left', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: '500px' }}>
            <div>
              ...
              <ul style={{ padding: 0, margin: 0, listStyle: 'none' }}>
                {[
                  ...
                  <li key={idx} style={{ display: 'flex', gap: '12px', marginBottom: '16px', fontSize: '15px', color: '#475569', lineHeight: '1.5' }}>
            ...
            <span style={{ fontSize: '72px', fontWeight: '900', color: '#f1f5f9', position: 'absolute', bottom: '20px', right: '32px', zIndex: 1 }}>01</span>
          </div>
          ...
          <div style={{ background: 'white', borderRadius: '20px', borderTop: '8px solid #1e2445', padding: '40px 32px', boxShadow: '0 10px 30px rgba(0,0,0,0.03)', position: 'relative', textAlign: 'left', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: '500px' }}>
            <div>
              <div style={{ width: '60px', height: '60px', borderRadius: '12px', background: '#f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '28px' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 60 60" fill="none">
                  <path d="M47.25 22.8559L54.6562 21.6934" stroke="#283466" stroke-width="3"/>
                  <path d="M44.9375 16.0406L49.5687 13.3125" stroke="#283466" stroke-width="3"/>
                  <path d="M40.2109 10.9973L43.3234 4.22852" stroke="#283466" stroke-width="3"/>
                  <path d="M31.3578 10.0223L31.3203 4.65039" stroke="#283466" stroke-width="3"/>
                  <path d="M22.7687 11.3348L20.2656 4.22852" stroke="#283466" stroke-width="3"/>
                  <path d="M16.8641 15.9652L12.1484 13.3965" stroke="#283466" stroke-width="3"/>
                  <path d="M14.7969 22.4723L7.53125 21.2441" stroke="#283466" stroke-width="3"/>
                  <path d="M24.5812 42.6281C24.5812 37.7906 21.5906 33.7312 19.9781 30.7312C19.0823 29.0654 18.6121 27.204 18.6094 25.3125C18.6094 18.9469 24.4312 13.7812 30.7969 13.7812" stroke="#283466" stroke-width="3"/>
                  <path d="M37.0125 42.6281C37.0125 37.7906 40.0031 33.7312 41.6156 30.7312C42.5115 29.0654 42.9817 27.204 42.9844 25.3125C42.9844 18.9469 37.1625 13.7812 30.7969 13.7812" stroke="#283466" stroke-width="3"/>
                  <path d="M37.9156 42.3652H24.1438C23.0461 42.3652 22.1562 43.2551 22.1562 44.3527V44.3621C22.1562 45.4598 23.0461 46.3496 24.1438 46.3496H37.9156C39.0133 46.3496 39.9031 45.4598 39.9031 44.3621V44.3527C39.9031 43.2551 39.0133 42.3652 37.9156 42.3652Z" stroke="#283466" stroke-width="3"/>
                  <path d="M36.8266 46.3398H25.2297C24.132 46.3398 23.2422 47.2297 23.2422 48.3273V48.3367C23.2422 49.4344 24.132 50.3242 25.2297 50.3242H36.8266C37.9242 50.3242 38.8141 49.4344 38.8141 48.3367V48.3273C38.8141 47.2297 37.9242 46.3398 36.8266 46.3398Z" stroke="#283466" stroke-width="3"/>
                  <path d="M34.0469 50.3242V51.1117C34.0797 51.5281 34.0261 51.9469 33.8892 52.3416C33.7524 52.7362 33.5354 53.0984 33.2519 53.4051C32.9684 53.7119 32.6245 53.9567 32.2418 54.1241C31.8591 54.2915 31.4458 54.3779 31.0281 54.3779C30.6104 54.3779 30.1972 54.2915 29.8145 54.1241C29.4318 53.9567 29.0879 53.7119 28.8043 53.4051C28.5208 53.0984 28.3038 52.7362 28.167 52.3416C28.0302 51.9469 27.9765 51.5281 28.0094 51.1117V50.3242" stroke="#283466" stroke-width="3"/>
                  <path d="M23.0312 24.6087C23.0781 23.6858 23.3063 22.7811 23.7031 21.9465C24.0998 21.1118 24.6571 20.3636 25.3432 19.7445C26.0294 19.1254 26.8308 18.6477 27.7017 18.3386C28.5726 18.0295 29.4959 17.8951 30.4188 17.9431" stroke="#283466" stroke-width="3"/>
                </svg>
              </div>
              <h3 style={{ fontSize: '24px', fontWeight: '800', color: '#1e2445', marginBottom: '24px' }}>The Solutions</h3>
            ...
            <span style={{ fontSize: '72px', fontWeight: '900', color: '#f1f5f9', position: 'absolute', bottom: '20px', right: '32px', zIndex: 1 }}>02</span>
          </div>
            ...
            <div>
              <div style={{ width: '60px', height: '60px', borderRadius: '12px', background: '#f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '28px' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 60 60" fill="none">
                  <path d="M52.5 52.5H15.5C12.6997 52.5 11.2996 52.5 10.2301 51.955C9.28923 51.4757 8.52432 50.7108 8.04497 49.77C7.5 48.7005 7.5 47.3002 7.5 44.5V7.5M17.5 37.5L30 22.5L40 32.5L52.5 17.5" stroke="#283466" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              </div>
              <h3 style={{ fontSize: '24px', fontWeight: '800', color: '#1e2445', marginBottom: '12px' }}>The Impact</h3>
              <p style={{ fontSize: '14px', color: '#64748b', marginBottom: '20px', lineHeight: '1.4' }}>An easy-to-use digital platform with fun activities for older people in care.</p>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
                {[
                  ...
                  <div key={idx} style={{ background: '#f8fafc', padding: '8px', borderRadius: '8px', border: '1px solid #f1f5f9', textAlign: 'center' }}>
                    <strong style={{ fontSize: '14px', color: '#1e2445', display: 'block' }}>{stat.value}</strong>
                    <span style={{ fontSize: '10px', color: '#64748b', display: 'block', marginTop: '2px', lineHeight: '1.1' }}>{stat.label}</span>
                  </div>
                ))}
              </div>
            </div>
            <span style={{ fontSize: '72px', fontWeight: '900', color: '#f1f5f9', position: 'absolute', bottom: '20px', right: '32px', zIndex: 1 }}>03</span>
          </div>
